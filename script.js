document.addEventListener('DOMContentLoaded', () => {
    ...
    // Ajout de liens indépendants (Tâches, Notes, Documents) hors catégorie
    // On les insère juste après Accueil et avant Paramètres
    const independentLinks = [
        { name: "Tâches", url: "taches.html", icon: "fa-tasks" },
        { name: "Notes", url: "notes.html", icon: "fa-sticky-note" },
        { name: "Documents", url: "documents.html", icon: "fa-file-alt" }
    ];
